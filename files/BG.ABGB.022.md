...
**FIXME** H4: <h4 class="UeberschrArt AlignCenter">Von der Verbindlichkeit zum Schadenersatze:</h4>
...
**FIXME** H4: <h4 class="UeberschrArt AlignCenter">Insbesondere</h4>
...
**FIXME** H4: <h4 class="UeberschrArt AlignCenter">Besonders durch die Verzögerung der Zahlung.</h4>
