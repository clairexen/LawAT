# BG.ABGB.028 — Allgemeines bürgerliches Gesetzbuch (ABGB)
**Typ:** Bundesgesetz  
**Kurztitel:** ABGB  
...
**RisEx-Link:** https://github.com/clairexen/RisEx/blob/main/files/BG.ABGB.028.md  
*Mit RisEx für RisEn-GPT von HTML zu MarkDown konvertiert. (Irrtümer und Fehler vorbehalten.)*

*(Fortsetzg. v. [BG.ABGB.027](BG.ABGB.027.md))*
...
`END-OF-DATA-FILE` *(fortges. in [BG.ABGB.029](BG.ABGB.029.md))*
