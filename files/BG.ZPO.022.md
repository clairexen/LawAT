# BG.ZPO.022 — Zivilprozessordnung (ZPO)
**Typ:** Bundesgesetz  
**Kurztitel:** ZPO  
...
**RisEx-Link:** https://github.com/clairexen/RisEx/blob/main/files/BG.ZPO.022.md  
*Mit RisEx für RisEn-GPT von HTML zu MarkDown konvertiert. (Irrtümer und Fehler vorbehalten.)*

*(Fortsetzg. v. [BG.ZPO.021](BG.ZPO.021.md))*
...
`END-OF-DATA-FILE` *(fortges. in [BG.ZPO.023](BG.ZPO.023.md))*
